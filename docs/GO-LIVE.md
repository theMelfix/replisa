...
|---|---|---|
| **Prodotti + Price ID su Stripe** | Il checkout/abbonamenti non funzionano; `PlanLimits` cade sul default | Dashboard Stripe → prodotti (mensile+annuale) + add-on → Price ID nell'overlay |
